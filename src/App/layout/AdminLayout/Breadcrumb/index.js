...
import { UserService } from "../../../../MyApp/auth/userService";
...
class Breadcrumb extends Component {
    ...
    componentDidMount() {
        if(UserService.getCurrentRole() == "Admin") {
            (navigation.adminMenuItems).map((item, index) => {
    ...
    render() {
        ...
        document.title = title + ' | Best School App';
