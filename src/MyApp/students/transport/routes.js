...
function TransportRoutes() {
    ...
    const ref = firebase.firestore().collection('transportroute');
                                ...
                                <Col md={6}>
                                    <Form>
                                        <Form.Group>
                                            ...
                                            <Form.Control as="select" size="sm" name="Transport" className="mb-3" value={statePage.transport}
                                                onChange={handleChange}>
                                                <option value="" >Select</option>
                                                {transports.map(({ name }, index) => <option value={name} >{name}</option>)}
                                            </Form.Control>
                                        </Form.Group>
