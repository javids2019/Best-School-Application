...
function ClassNames() {
    ...
    const ref = firebase.firestore().collection('classnames');
        ...
        <Fragment>
            <Row>
                <Col>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Class Names</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            <Row>
                                <Col md={6}>
                                    <Form>
                                        <Form.Group controlId="formQuestionTypes">
                                            <Form.Label>Class Names</Form.Label>
                                            <Form.Control type="text"  size="sm" value={name} placeholder="Class Names" onChange={(e) => setName(e.target.value)} />
                                        </Form.Group>

                                        <Form.Group controlId="formDescription">
                                            <Form.Label>Description</Form.Label>
                                            <Form.Control type="text"  size="sm" value={description} placeholder="Description" onChange={(e) => setDescription(e.target.value)} />
                                        </Form.Group>
