...
function RoomeDetails() {
    ...
    const ref = firebase.firestore().collection('roomdetails');
                                ...
                                <Col md={6}>
                                    <Form>
                                        <Form.Group>
                                            ...
                                            <Form.Control as="select" size="sm" name="hostel" className="mb-3" value={statePage.hostel}
                                                onChange={handleChange}>
                                                <option value="" >Select</option>
                                                {hostels.map(({ name }, index) => <option value={name} >{name}</option>)}
                                            </Form.Control>
                                        </Form.Group>
