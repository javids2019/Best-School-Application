...
//import UserContext  from '../auth/userService';
...
function AssessmentType() {
    ...
    const ref = firebase.firestore().collection('assessmenttype');
        ...
        <Fragment>
            <Row>
                <Col>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Assessment Types</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            <Row>
                                <Col md={6}>
            ...
            <Row>
                <Col>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Assessment Type</Card.Title>
                        </Card.Header>
                        <Card.Body>
