...
function QuizReport() {
    ...
    const ref = firebase.firestore().collection('quizreport');
                            ...
                            <Table responsive>
                                <thead>
                                    <tr>
                                        ...
                                        <th>Percentage</th>
                                        <th>Remaining %</th>
                                        <th>NoOfNotAnsweredQuestions</th>
                                        <th>NoOfAnsweredCurrect</th>
                                        <th>NoOfQuestionAnswered</th>
                                        <th>Score</th>
                                        <th>Timer In Hr</th>
                                        <th>Timer In Min </th>
                                        <th>Email</th>
                                ...
                                <tbody>
                                    {pageData.map(pageItem => (
                                        <tr>
                                            ...
                                            <td>{pageItem.totalQuestions}</td>
                                            <td>{pageItem.percentage}</td>
                                            <td>{pageItem.remainingPercentage}</td>
                                            <td>{pageItem.noOfNotAnsweredQuestions}</td>
                                            <td>{pageItem.noOfAnsweredCurrect}</td>
                                            <td>{pageItem.noOfQuestionAnswered}</td>
                                            <td>{pageItem.score}</td> 
                                            <td>{pageItem.timerInHr}</td>
                                            <td>{pageItem.timerInMin}</td>
