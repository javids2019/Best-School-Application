...
function PhoneCallLog() {
    ...
    // Dropdown ref
    const ref = firebase.firestore().collection('phonecalllog');
                                ...
                                <Row>
                                    ...
                                    <Col>
                                        <Form.Group>
                                            ...
                                            <Form.Control size="sm" type="Date"  name="NextFollowUpDate" value={statePage.NextFollowUpDate} className="mb-3" placeholder="Next Follow Up Date"
                                                onChange={handleChange}>
                                            </Form.Control>
                                        </Form.Group>
                                    </Col>
                                    <Col>
                                        <Form.Group>
                                            ...
                                            <Form.Control size="sm" name="CallDuration" value={statePage.CallDuration} className="mb-3" placeholder="Call Duration"
                                                onChange={handleChange}>
                                            </Form.Control>
                                        </Form.Group>
                                    </Col>
                                    <Col>
                                        <Form.Group>
                                            ...
                                            <Form.Control size="sm" name="CallType" value={statePage.CallType} className="mb-3" placeholder="Call Type"
                                                onChange={handleChange}>
                                            </Form.Control>
                                        </Form.Group>
                                    </Col>
