...
function PostalSent() {
    ...
    // Dropdown ref
    const ref = firebase.firestore().collection('postaldispatch');
                                ...
                                <Row>
                                    <Col>
                                        <Form.Group>
                                            ...
                                            <Form.Control size="sm" name="ToTitle" value={statePage.ToTitle} className="mb-3" placeholder="To Title"
                                    ...
                                    <Col >
                                        <Form.Group>
                                            ...
                                            <Form.Control size="sm"  type="text" name="FromTitle" value={statePage.FromTitle} className="mb-3" placeholder="From Title"
                                                onChange={handleChange}>
                                            </Form.Control>
                                        </Form.Group>
                                    </Col>
